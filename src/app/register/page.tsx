...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-8 px-4 relative">
      ...
      <div className="w-full max-w-xl bg-slate-900/90 backdrop-blur-xl border border-emerald-500/20 rounded-3xl p-6 md:p-8 shadow-2xl shadow-emerald-950/30 relative overflow-hidden">
        {/* Top Gradient Bar */}
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-3.5">
            <span className="px-2.5 py-1 rounded-lg bg-slate-800/80 border border-slate-700/60 text-[11px] text-slate-300 font-medium flex items-center gap-1">
              <Zap className="w-3 h-3 text-amber-400" /> Gratis Akses Coba
            </span>
            <span className="px-2.5 py-1 rounded-lg bg-slate-800/80 border border-slate-700/60 text-[11px] text-slate-300 font-medium flex items-center gap-1">
              <Store className="w-3 h-3 text-emerald-400" /> Kasir & Stok Opname
            </span>
            <span className="px-2.5 py-1 rounded-lg bg-slate-800/80 border border-slate-700/60 text-[11px] text-slate-300 font-medium flex items-center gap-1">
              <ShieldCheck className="w-3 h-3 text-teal-400" /> Multi-User Owner/Kasir
            </span>
          </div>
        </div>
        ...
        <div className="mt-6 pt-5 border-t border-slate-800/80">
          <div className="p-3.5 rounded-2xl bg-slate-950/60 border border-slate-800/80 flex items-center justify-between gap-3">
            <div className="text-left">
              <p className="text-xs font-bold text-white">Sudah memiliki akun toko?</p>
              <p className="text-[11px] text-slate-400">Masuk langsung ke sistem kasir</p>
            </div>
            <Link
              href="/login"
